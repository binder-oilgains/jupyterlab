...
[![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/binder-oilgains/jupyterlab/main?urlpath=lab/tree/index.ipynb)
...
`http://mybinder.org/v2/gh/<owner>/jupyterlab/<branch>?urlpath=lab/tree/index.ipynb`
